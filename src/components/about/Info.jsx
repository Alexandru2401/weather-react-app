  ...
  return (
    <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 justify-items-center sm:my-6 md:my-16">
        ...
        <Card className={`${cardStyle} z-0 relative p-0 min-h-[350px] mb-16`}>
        ...
        <Card className={cardStyle}>
          <h2 className="text-xl mb-2">Detailed Data</h2>
          <p>
