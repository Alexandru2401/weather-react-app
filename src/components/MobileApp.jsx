  ...
  return (
    <section className="flex flex-col justify-center items-center relative">
      ...
      <div className="w-2/4 min-h-[700px] flex items-center justify-center rounded-full shadow-sm border-dashed border-black border-2 my-9">
        ...
        <span className={`${spanStyle} ${shadow} right-32`}>Temperature in your location</span>
        <span className={`${spanStyle} ${shadow} left-80 top-1/3`}>Daily forecast</span>
        <img
          src={rain}
      ...
      <div className="absolute bottom-4 left-2 p-3 rounded-3xl bg-slate-400 flex items-center justify-center">
        ...
        <span className="text-slate-900 mx-2 bg-slate-200 rounded-3xl p-2">App in your pocket! Donwload it!</span>
      </div>
